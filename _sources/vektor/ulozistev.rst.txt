...
.. note:: Varianta JNDI vyžaduje konfiguraci na úrovni aplikačního serveru a pro začátečníky není vhodná. Navíc testy ukázaly, že je připojení přes JNDI o něco pomalejší. Vhodné je v případě, že již organizace JNDI běžně využívá.
