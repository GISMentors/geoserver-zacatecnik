...
Důvodem proč musíme psát jednotlivé `Rule` do samostatních `FeatureTypeStyle` je, že Geoserver prvky v jednom `FeatureTypeStyle` vykresluje v pořadí dle interního ID. 
